  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="focus-visible:ring-ring/50 min-h-0 flex-1 rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
